...
import com.mt.lamdatrack.Rate.nodes.Comment;
...
import com.mt.lamdatrack.Rate.nodes.PseudoTextElement;
import com.mt.lamdatrack.Rate.nodes.TextNode;
import com.mt.lamdatrack.Rate.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.mt.lamdatrack.Rate.internal.Normalizer.lowerCase;
import static com.mt.lamdatrack.Rate.internal.Normalizer.normalize;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.mt.lamdatrack.Rate.nodes.Attribute> values = element.attributes().asList();
            for (com.mt.lamdatrack.Rate.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    com.mt.lamdatrack.Rate.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
